...
class TwitterDownloader:
    ...
    def classify_error(self, stderr_text: str) -> str:
        ...
        patterns = [
            ...
            (["login", "sign in", "authentication", "private", "protected"], "AUTH_NEED_LOGIN"),
            (["cookies are no longer valid"], "AUTH_COOKIE_INVALID"),
            (["not available", "unavailable", "deleted"], "CONTENT_UNAVAILABLE"),
    ...
    def should_use_cookie(self, error_source: str) -> bool:
        return error_source in {"AUTH_NEED_LOGIN", "NETWORK_FORBIDDEN", "NETWORK_RATE_LIMIT"}
