...
def get_success_message(platform_name: str, *, cookie_used: bool = False, deno_used: bool = False) -> str:
...
def run_command(cmd: list[str], progress_parser=None, idle_callback=None) -> dict:
